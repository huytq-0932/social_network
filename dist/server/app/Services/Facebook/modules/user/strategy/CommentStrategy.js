...
class CommentStrategy extends BaseStrategy_1.default {
    constructor({ content, groupId, postId }) {
        super();
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield this.request.get(postUrl);
...
exports.default = CommentStrategy;
